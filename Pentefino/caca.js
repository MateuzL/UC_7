...
(function () {
  ...
  const GUIDE_IMAGE = "assets/personagens/abacate.webp";
  ...
  section.innerHTML = `
    <div class="shell opf-game-shell">
      ...
      <aside class="opf-mission-guide reveal" aria-label="Guia da missão">
        <span class="opf-guide-tag">⚓ MARINHEIRO ABACATE · GUIA</span>
        <img class="opf-guide-character" src="${GUIDE_IMAGE}" alt="Marinheiro Abacate segurando um pente">
